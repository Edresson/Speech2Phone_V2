...
from models.speech2phon import SpiraConvV1, SpiraConvV2
...
def run_test(args, checkpoint_path, testloader, c, model_name, ap, cuda=True):
    ...
    padding_with_max_lenght = c.dataset['padding_with_max_lenght']
    if(model_name == 'speech2phon_v1'):
        model = SpiraConvV1(c)
    elif (model_name == 'speech2phon_v2'):
        model = SpiraConvV2(c)
...
if __name__ == '__main__':
    # python test.py --test_csv ../SPIRA_Dataset_V1/metadata_test.csv -r ../SPIRA_Dataset_V1/ --checkpoint_path ../checkpoints/speech2phon-trained-with-SPIRA_Dataset_V1/speech2phon/checkpoint_1068.pt --config_path ../checkpoints/speech2phon-trained-with-SPIRA_Dataset_V1/speech2phon/config.json  --batch_size 5 --num_workers 2 --no_insert_noise True
